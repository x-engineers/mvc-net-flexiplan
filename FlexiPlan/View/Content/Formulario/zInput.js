$.fn.zInput = function () {
    ...
    $.each(inputNames, function (index, value) {
        ...
        if (elementType == "radio") {
            $element.wrap(function () { return '<div class="zchecked col-xs-12 col-sm-12 col-md-6 col-lg-3"><div class="zInput"><span style="display:table;width: 100%;height: 100%;"><span style="display: table-cell;vertical-align:middle;">' + $(this).attr("title") + '</span></span></div></div>' });
        }
    });
