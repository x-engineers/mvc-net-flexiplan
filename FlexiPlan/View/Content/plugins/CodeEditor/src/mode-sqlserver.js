...
var SqlServerHighlightRules = function() {
    ...
    keywords += "|TYPE";
    keywords += "|CLASE_PRODUCTO|CODIGO_CLIENTE|NUMERO_PRODUCTO";
    keywords += "|CODIGO_USUARIO|FECHA_APLICACION|CODIGO_FINANCIERA|COLECTOR_MOVIMIENTO|TIPO_TRANSACCION|TIPO_OPERACION|FORMA_PAGO|FECHA_CALENDARIO|CODIGO_AGENCIA_BANCO";
    keywords += "|VALOR_TRANSACCION|NUMERO_RECIBO|CODIGO_PATRONO|ESTADO_CARTERA|COLECTOR_CONVENIO|FACTURA_CONVENIO|SALDO_CAPITAL|SALDO_INTERES|SALDO_SEGUROS_IVA|SALDO_OTROS";
    keywords += "|EXCEDENTE|CAPITAL_VIGENTE|CAPITAL_MORA|CAPITAL_VENCIDO|INTERES_VIGENTE|INTERES_MORA|INTERES_VENCIDO|FECHA_CANCELACION|FECHA_APERTURA|FECHA_VENCIMIENTO";
    keywords += "|VALOR_CUOTA|MONTO_OTORGADO|VALOR_VALUO|VALOR_CONTABLE|FECHA_SOLICITUD|NOMBRE_COMPLETO|TOTAL_INGRESOS|ES_PEP|REQUIERE_SEGUIMIENTO|ES_RELACIONADO_PEP";
